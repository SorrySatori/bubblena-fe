            ...
            <div class="product-footer">
              ...
              <div v-if="getSelectedVariant(product)?.inStock" class="cart-controls" @click.stop>
                ...
                <div class="quantity-picker">
                  <button type="button" @click.stop.prevent="decrementQuantity(product, $event)" class="qty-btn" :disabled="(quantities[product._id] || 1) <= 1">−</button>
                  <span class="qty-value">{{ quantities[product._id] || 1 }}</span>
                  <button type="button" @click.stop.prevent="incrementQuantity(product, $event)" class="qty-btn" :disabled="(quantities[product._id] || 1) >= (getSelectedVariant(product)?.stockCount || 10)">+</button>
                </div>
