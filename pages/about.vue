...
.about-section, .team-section, .mission-section {
  margin-bottom: 4rem;
}

.about-section h2, .team-section h2, .mission-section h2 {
  font-size: 2rem;
  color: var(--secondary-color);
...
.about-section h2::after, .team-section h2::after, .mission-section h2::after {
  content: '';
  position: absolute;
  bottom: -10px;
  left: 0;
